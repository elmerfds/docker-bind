...
RUN apt-get -qqqy update && apt-get -qqqy dist-upgrade && apt-get -qqqy install bind9=$DEB_VERSION bind9-utils=$DEB_VERSION && DEBIAN_FRONTEND=noninteractive apt-get -y install webmin tzdata
